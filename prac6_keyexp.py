...
def key_expansion(key):
    ...
    for i in range(4):
        ...
        key_schedule.append((key_symbols[4 * i] << 24) |
...
key = "2475A2B33475568831E2120013AA54870"#""

expanded_keys = key_expansion(key)

for i in range(0, len(expanded_keys), 4):

    print(f"Round {i//4}: {expanded_keys[i]:08X} {expanded_keys[i+1]:08X} {expanded_keys[i+2]:08X} {expanded_keys[i+3]:08X}")